...
const FeedbackStep = ({
  ...
  const showEmailField = room.feedback?.emailRequirement !== "none";
  ...
  const handleSubmit = () => {
    ...
    if (email.trim() && !emailConsent) {
      toast.error("Please accept the privacy notice to include your email");
      return;
    }
        ...
        {showEmailField && (
          <TextField
            ...
            onChange={(e) => {
              ...
              if (!e.target.value.trim()) setEmailConsent(false);
            }}
            fullWidth
            size="small"
          ...
          <FormControlLabel
            ...
            label={
              <Typography variant="caption" color="text.secondary">
                I agree my email may be used to reply to my feedback.{" "}
...
type Step = "rating" | "feedback" | "google" | "survey";
