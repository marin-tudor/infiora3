...
router.post('/refresh-tokens', authLimiter, validate(authValidation.refreshTokens), authController.refreshTokens);
router.get('/refresh-tokens', authLimiter, authController.refreshTokens);
