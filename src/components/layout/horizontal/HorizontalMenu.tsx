  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem icon={<i className='ri-door-line' />} href={`/${locale}/rooms`}>
          {dictionary.rooms}
        </MenuItem>
        <MenuItem icon={<i className='ri-line-chart-line' />} href={`/${locale}/insights`}>
          {dictionary.analytics}
        </MenuItem>
        <MenuItem icon={<i className='ri-bar-chart-box-line' />} href={`/${locale}/analytics`}>
          Revenue Analytics
        </MenuItem>
      </Menu>
      {/* <Menu
