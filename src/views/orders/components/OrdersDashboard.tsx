  ...
  return (
    <Stack gap={3}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={6} md={3}>
          <StatCard label={t.pending || 'Pending'} value={analytics.pendingOrders} sub={t.awaitingAction || 'Awaiting action'} color='warning.main' />
        </Grid>
        <Grid item xs={6} md={3}>
          <StatCard label={t.completed || 'Completed'} value={analytics.completedOrders} sub={t.successfullyDelivered || 'Successfully delivered'} color='success.main' />
        </Grid>
        <Grid item xs={6} md={3}>
          <StatCard
        ...
        <Grid item xs={6} md={3}>
          <StatCard label={t.cancelled || 'Cancelled'} value={analytics.cancelledOrders ?? 0} sub={t.totalCancelled || 'Total cancelled'} color='error.main' />
        </Grid>
        <Grid item xs={6} md={3}>
          <StatCard
      ...
      {visits && (
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} md={3}>
            <StatCard label={t.browsedOnly || 'Browsed Only'} value={visits.notConverted} sub={t.viewedWithoutOrdering || 'Viewed without ordering'} color='text.secondary' />
          </Grid>
          <Grid item xs={6} md={3}>
            <StatCard label={t.conversion || 'Conversion'} value={`${visits.conversionRate}%`} sub={t.visitorsWhoOrdered || 'Visitors who ordered'} color='primary.main' />
          </Grid>
        </Grid>
      )}
