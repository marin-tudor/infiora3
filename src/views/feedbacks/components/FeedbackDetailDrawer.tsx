...
const AnswerRenderer = ({ type, answer }: { type?: string; answer: any }) => {
  if (answer === null || answer === undefined || answer === '')
    return <Typography variant='body2' color='text.secondary' fontStyle='italic'>—</Typography>
  ...
  switch (type) {
    ...
    case 'single_choice':
      return (
        <Chip label={String(answer)} size='small' variant='outlined' color='primary' />
      )
  ...
  return (
    ...
    >
      ...
      <Stack direction='row' gap={1} sx={{ px: 3, pt: 2 }}>
        {hasReview && (
          <Chip label={dictionary.reviewOnly} size='small' color='primary' variant='outlined' />
        )}
        {hasSurvey && (
          <Chip label={dictionary.surveyOnly} size='small' color='secondary' variant='outlined' />
        )}
      </Stack>
