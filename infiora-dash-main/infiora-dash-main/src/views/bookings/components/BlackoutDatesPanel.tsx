      ...
      <CardContent sx={{ pb: '12px !important' }}>
        ...
        >
          <Stack sx={{ minWidth: 170 }}>
            ...
            <TextField type='date' size='small' value={formDate} onChange={e => setFormDate(e.target.value)} required />
          </Stack>
          ...
          <List dense disablePadding>
            {blackouts.map((b, idx) => (
              <Stack key={b._id} spacing={0}>
                ...
                {idx < blackouts.length - 1 && <Divider component='li' />}
              </Stack>
            ))}
          </List>
        )}
