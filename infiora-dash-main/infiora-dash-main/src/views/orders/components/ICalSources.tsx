...
import {
  ...
  TextField, Select, MenuItem, FormControl, FormControlLabel,
        ...
        <Stack spacing={2} sx={{ mt: 1 }}>
          <Stack spacing={0.5}>
            ...
            <FormControl fullWidth>
              <Select value={platform} onChange={e => setPlatform(e.target.value as ICalPlatform)}>
          ...
          {platform === 'custom' && (
            <Stack spacing={0.5}>
              ...
              <TextField value={label} onChange={e => setLabel(e.target.value)} fullWidth placeholder='e.g. My listing' />
            </Stack>
          )}
          <Stack spacing={0.5}>
            <Typography variant='caption' color='text.secondary' fontWeight={600}>iCal URL</Typography>
            <TextField
              value={url}
