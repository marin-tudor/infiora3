...
const SortableImageItem: React.FC<SortableImageItemProps> = ({ id, image, index, rectangle, disabled, onRemove }) => {
...
return
  ...
  return (
    <>
      <LoadingBackdrop
        open={isConverting}
        message={convertingCount > 1 ? `Converting ${convertingCount} images...` : 'Converting HEIC image...'}
      />
      <Stack gap={2}>
