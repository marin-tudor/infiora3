...
const LinksList = ({ room, links }: { room: IRoom; links: ILink[] }) => {
      ...
      <Stack gap={2} mx={5}>
        {links.map((link) => (
          <Accordion
            ...
            elevation={0}
            expanded={
              ["link", "wifi", "text", "blog"].includes(link.type)
                ? false
                : undefined
            }
            sx={{
              ...
              <Button
                ...
                startIcon={
                  ...
                  (link.imageType === "icon" ? (
                    ...
                    >
                      <IconPickerItem value={link.image} size={40} />
                    </Box>
                  ) : (
                    <Box
                      style={{
                  ...
                  {link.items.map((item) => {
                    return (
                      <Accordion
                        ...
                        elevation={0}
                        expanded={
                          ["link", "wifi", "blog"].includes(item.type)
                            ? false
                            : undefined
                        }
                        sx={{
